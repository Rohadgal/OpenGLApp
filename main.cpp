...
void CreateObjects() {
	...
	GLfloat vertices[] = {
		-1.0f, -1.0f * float(sqrt(3)) / 3, 0.0f,  // left
		0.0f, -1.0f * float(sqrt(3)) / 3, 1.0f * float(sqrt(3)) * 2 / 3,  // bottom
		1.0f, -1.0f * float(sqrt(3)) / 3, 0.0f, // right
		0.0f, 1.0f * float(sqrt(3)) * 2 / 3, 1.0f * float(sqrt(3))/ 3 //top
	};
